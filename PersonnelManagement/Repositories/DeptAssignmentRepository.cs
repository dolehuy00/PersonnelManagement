...
{
    public class DeptAssignmentRepository : GenericCurdRepository<DeptAssignment>, IDeptAssignmentRepository
    {
        ...
        {
            var query = this._context.DeptAssignments.AsQueryable();
